    ...
    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border border-gray-100 dark:border-gray-700 p-5">
      ...
      {currentTimerDuration > 0 && (
        <TimerDisplay 
          timer={timer}
          timeLeft={timeLeft}
          startTimer={() => startTimer(currentTimerDuration)}
          toggleTimer={toggleTimer}
          resetTimer={() => resetTimer(currentTimerDuration)}
      ...
      <div className="flex justify-between mt-6">
        <button 
          onClick={() => {
            ...
            resetTimer(recipe.steps[Math.max(0, currentStep - 1)].timer || 0);
          }}
        ...
        {isLastStep ? (
          ...
          <button 
            onClick={() => {
              ...
              resetTimer(recipe.steps[Math.min(recipe?.steps.length - 1, currentStep + 1)].timer || 0);
            }}
